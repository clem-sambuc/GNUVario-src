...
#define BIAS_CORRECTION_GYRO_CAL_BIAS {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
#define BIAS_CORRECTION_ACCEL_CAL_BIAS {0, 0, 0}
#define BIAS_CORRECTION_ACCEL_CAL_SCALE 0
#define BIAS_CORRECTION_MAG_CAL_BIAS {0, 0, 0}
#define BIAS_CORRECTION_MAG_CAL_PROJ_SCALE -16689
#define BIAS_CORRECTION_ACCEL_CAL_BIAS_MULTIPLIER 7
#define BIAS_CORRECTION_MAG_CAL_BIAS_MULTIPLIER 5

//#define BIAS_CORRECTION_STATIC_CALIBRATION

/*#define BIAS_CORRECTION_GYRO_CAL_BIAS {0x00, 0x00, 0x29, 0xdf, 0xff, 0xff, 0x9f, 0x4a, 0xff, 0xff, 0xb5, 0xe9}
#define BIAS_CORRECTION_ACCEL_CAL_BIAS {-3416, 9992, -31522}
#define BIAS_CORRECTION_ACCEL_CAL_SCALE -165
#define BIAS_CORRECTION_MAG_CAL_BIAS {-5097, 4319, 22227}
#define BIAS_CORRECTION_MAG_CAL_PROJ_SCALE 9247*/

/*#define BIAS_CORRECTION_GYRO_CAL_BIAS {0x00, 0x00, 0x53, 0x5a, 0xff, 0xff, 0x77, 0x56, 0xff, 0xff, 0xc1, 0x76}
#define BIAS_CORRECTION_ACCEL_CAL_BIAS {-356, -293, -23473}
#define BIAS_CORRECTION_ACCEL_CAL_SCALE -33169
#define BIAS_CORRECTION_MAG_CAL_BIAS {260, 26368, -24674}
#define BIAS_CORRECTION_MAG_CAL_PROJ_SCALE -32495
#define BIAS_CORRECTION_ACCEL_CAL_BIAS_MULTIPLIER 5
#define BIAS_CORRECTION_MAG_CAL_BIAS_MULTIPLIER 5*/
